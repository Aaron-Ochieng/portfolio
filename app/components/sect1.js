        ...
        <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
            ...
            <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
                <li className="mr-5 shrink-0 text-xs">
                    <Link className="block hover:text-gray-400 hover:scale-150 dark:hover:text-slate-200" href="https://github.com/Aaron-Ochieng" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="GitHub">
                ...
                <li className="mr-5 shrink-0 text-xs">
                    <Link className="block hover:text-gray-400 hover:scale-150 dark:hover:text-slate-200" href="https://ke.linkedin.com/" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="GitHub">
                        <FaLinkedin className="h-6 w-6" />
                    </Link>
                </li>
                <li className="mr-5 shrink-0 text-xs">
                    <Link className="block hover:text-gray-400 hover:scale-150 dark:hover:text-slate-200" href="https://x.com/Aaron_Ochieng_" target="_blank" rel="noreferrer noopener" aria-label="GitHub (opens in a new tab)" title="GitHub">
